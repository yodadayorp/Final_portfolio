      ...
      },
      {
        ...
        content: (
          <div className="space-y-6">
            ...
            <p>In the digital landscape, we also consider "Luminous Ergonomics"ΓÇöhow colors behave on OLED vs LCD screens, and how they contribute to eye fatigue during long browsing sessions.</p>
          </div>
        )
      },
      {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      },
      {
        ...
        content: (
          <div className="space-y-6">
            <p>100/100 on Google Lighthouse isn't just for bragging rightsΓÇöit's a critical SEO signal. We optimize every image into AVIF formats, minimize third-party scripts, and use CSS-only solutions wherever possible to keep the main thread lean.</p>
      ...
      process: [
        {
          ...
          desc: 'We go beyond superficial aesthetics to excavate the primal narratives of your brand. This involves deep psychological mapping to identify the core archetypeΓÇöbe it the Visionary, the Ruler, or the ExplorerΓÇöthat will anchor your visual sovereignty.'
        },
        {
          step: '02',
    ...
    details: {
      ...
      process: [
        ...
        },
        {
          ...
          desc: 'The final shift from "live" to "dominant." We run comprehensive stress tests, SEO synchronization, and accessibility audits to ensure your platform isn\'t just functionalΓÇöit\'s a high-converting machine that leads the market in performance metrics.'
        }
      ],
